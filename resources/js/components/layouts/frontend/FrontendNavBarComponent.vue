            ...
            <div class="flex items-center justify-between gap-5">
                ...
                <div class="relative hidden lg:block group">
                    ...
                    <div v-else
                        ...
                        <router-link
                            class="!text-primary w-full text-center h-12 leading-12 font-semibold tracking-wide rounded-full whitespace-nowrap"
                            :to="{ name: 'auth.signup' }">
                ...
                <button @click.prevent="openCanvas('cart-canvas')" type="button"
                    ...
                    <span v-if="carts.length > 0"
                        class="absolute top-4 ltr:right-1 rtl:left-1 text-[10px] font-medium h-4 px-1 leading-[14px] text-center rounded-full border border-heading text-white bg-[#000000]">
                        {{ carts.length }}
                    </span>
                </button>
                <!-- Card Button End -->
