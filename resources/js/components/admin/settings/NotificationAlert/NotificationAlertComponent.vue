                ...
                <form class="row" @submit.prevent="save(notificationAlert.slug, index)"
                    ...
                    <div class="col-12 xl:col-6" v-for="notification in notificationAlerts" :key="notification">
                        <div class="flex items-center justify-between mb-3">
                            <label class="capitalize text-sm text-heading">
                            {{ manualTranslations[notification.name] || notification.name }}</label>
...
export default {
    ...
    data() {
        return {
            ...
            "Order On The Way Message": "رسالة الطلب في الطريق",
            "Order Delivered Message": "رسالة تم تسليم الطلب",
            "Order Canceled Message": "رسالة إلغاء الطلب",
            "Order Rejected Message": "رسالة رفض الطلب",
            "Admin And Manager New Order Message": "رسالة الطلب الجديد للمسؤول والمدير"
        },
        };
    },
    mounted() {
