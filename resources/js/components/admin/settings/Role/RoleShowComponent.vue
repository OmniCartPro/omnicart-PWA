                        ...
                        <tbody v-if="permissions.length > 0" class="db-table-body">
                            <tr v-for="permission in permissions" :key="permission" class="db-table-body-tr">
                                ...
                                <td :colspan="!permission.children ? 5 : ''" class="db-table-body-td text-base capitalize">
                                    {{ manualTranslations[permission.title] || permission.title }}</td>
...
export default {
  ...
  "Online Orders": "طلبات عبر الإنترنت",
  "Return And Refunds": "الإرجاع والاسترداد",
  "Return Orders": "طلبات الإرجاع",
  Coupons: "الكوبونات",
  Promotions: "العروض الترويجية",
  "Product Sections": "أقسام المنتج",
