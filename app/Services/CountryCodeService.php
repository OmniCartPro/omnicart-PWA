...
{
    try {
        $allowedCallingCodes = ['+20', '+966', '+971', '+965', '+974', '+973', '+968', '+961', '+962', '+212'];
        ...
        foreach ($countries as $key => $country) {
            if (isset($country['calling_codes'][0]) && isset($country['flag']['emoji'])) {
                $code = $country['calling_codes'][0] == '+1201' ? '+1' : ($country['calling_codes'][0] == '+73' ? '+7' : $country['calling_codes'][0]);

                if (in_array($code, $allowedCallingCodes)) {
                    $countryArray[] = (object)[
                        'country_code' => $key,
